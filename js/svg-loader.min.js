(() => {
    ...
    r.d = (e, t) => {
        ...
        const {
            ...
            set: t,
            del: n
        } = r(175), o = r(905), a = r(941), s = r(701), i = [], c = {}, u = (e, t, r) => {
            const {
                enableJs: n,
                disableUniqueIds: u,
                disableCssScoping: d
            } = t, l = (new DOMParser).parseFromString(r, "text/html"), b = l.querySelector("svg"), f = (() => {
                if (i.length) return i;
                for (const e in document.head) e.startsWith("on") && i.push(e);
                return i
            })(), h = c[e.getAttribute("data-id")] || new Set, g = e.getAttribute("data-id") || `svg-loader_${s.incr()}`, p = {};
            ...
            const o = r.getAttribute("data-src"),
                a = r.getAttribute("data-cache"),
                s = "enabled" === r.getAttribute("data-js"),
                i = "disabled" === r.getAttribute("data-unique-ids"),
                c = "disabled" === r.getAttribute("data-css-scoping"),
                f = await (async t => {
                    try {
